...
@Singleton
public class BluetoothScannerManagerImpl implements BluetoothScannerManager {

    public static final String TAG = BluetoothScannerManagerImpl.class.getSimpleName();
                    ...
                    activity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (!isBluetoothDeviceAdded(device.getAddress())) {
                                logger.log(TAG, "Otrzymane RSSI urządzenia: " + String.valueOf(rssi));
    ...
    @Inject
    public BluetoothScannerManagerImpl() {
