...
public class InternetBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (intent.getAction()){
            case ApiConnectionProvider.ACTION_INTERNET_DEVICE_LOADED:
                List<InternetDeviceWrapper> internetDeviceWrapperList=  intent.getParcelableArrayListExtra(ApiConnectionProvider.KEY_INTERNET_DEVICE_LOADED);
                ...
                break;
            case ApiConnectionProvider.ACTION_INTERNET_DEVICE_ERROR:
                String message = intent.getStringExtra(ApiConnectionProvider.KEY_INTERNET_DEVICE_ERROR);
    ...
    public static IntentFilter makeGattUpdateIntentFilter() {
        ...
        intentFilter.addAction(ApiConnectionProvider.ACTION_INTERNET_DEVICE_LOADED);
        intentFilter.addAction(ApiConnectionProvider.ACTION_INTERNET_DEVICE_ERROR);
        return intentFilter;
    }
}
